...
public class Execute {
	 ...
	 * @throws ExecuteException
	 * @see <a href="http://wiki.freeswitch.org/wiki/Misc._Dialplan_Tools_detect_speech">FreeSWITCH wiki</a>
	 */
	 ...
	 * @param extension
	 * @param dialplan
	 * @param context   (will only be set if dialplan is not null)
	 * @throws ExecuteException
	 * @see <a href="http://wiki.freeswitch.org/wiki/Misc._Dialplan_Tools_execute_extension">FreeSWITCH wiki</a>
	 */
	 ...
	 *
	 * @throws ExecuteException
	 * @see Execute#playAndGetDigits(int, int, int, int, char, String, String, String, int)
	 ...
	 * @param optionalLoops set to a non zero nu,ber, -1 for infinate loop
	 * @throws ExecuteException
	 ...
	 */
	public String playAndDetectSpeech(String file, String engine, String grammer)
		throws ExecuteException {
		return playAndDetectSpeech(file, engine, grammer, "");
	}
	 ...
	 * @see <a href="http://wiki.freeswitch.org/wiki/Misc._Dialplan_Tools_play_and_detect_speech">FreeSWITCH wiki</a>
	 */
	public String playAndDetectSpeech(String file, String engine, String grammer, String optionalParams)
		throws ExecuteException {
	 ...
	 */
	public void queueDTMF(String digits, TimeUnit unit, int duration)
		throws ExecuteException {
		sendExeMesg("dtmf_digits", digits + "@" + MILLISECONDS.convert(duration, unit));
	}
	 ...
	 *
	 * @param file
	 * @param optionalTimeLimitSeconds the maximum duration of the recording.
	 * @param optionalSilenceThreshold is the energy level.
	 * @param optionalSilenceHits      how many positive hits on being below that thresh you can
	 *                                 tolerate to stop default hits are sample rate * 3 / the number
	 *                                 of samples per frame so the default, if missing, is 3.
	 * @param wateResources            By default record doesn't send RTP packets. This is generally
	 ...
	 * @param append                   append or overwite if file exists
	 * @param optionalRecordTile       store in the file header meta data (provided the file format
	 *                                 supports meta headers).
	 * @param optionalRecordCopyright  store in the file header meta data (provided the file format
	 *                                 supports meta headers).
	 * @param optionalRecordSoftware   store in the file header meta data (provided the file format
	 *                                 supports meta headers).
	 * @param optionalRecordArtist     store in the file header meta data (provided the file format
	 *                                 supports meta headers).
	 * @param optionalRecordComment    store in the file header meta data (provided the file format
	 *                                 supports meta headers).
	 * @param optionalRecordDate       store in the file header meta data (provided the file format
	 *                                 supports meta headers).
	 * @param optionalRecordRate       the sample rate of the recording.
	 * @throws ExecuteException
	 * @see <a href="http://wiki.freeswitch.org/wiki/Misc._Dialplan_Tools_record">FreeSWITCH wiki</a>
	 */
	 ...
	 * @param optionalRecordRate       the sample rate of the recording.
	 * @throws ExecuteException
	 * @see <a href="http://wiki.freeswitch.org/wiki/Misc._Dialplan_Tools_record_session">FreeSWITCH wiki</a>
	 */
	 ...
	 *
	 * @param endpoint ex:"sip:foo@bar.com " or "sip:foo@bar.com,sip:foo@end.com"
	 * @throws ExecuteException
	 * @see <a href="http://wiki.freeswitch.org/wiki/Misc._Dialplan_Tools_redirect">FreeSWITCH wiki</a>
	 */
	 ...
	 *
	 * @param code ex: "407" or "480 Try again later"
	 * @throws ExecuteException
	 * @see <a href="http://wiki.freeswitch.org/wiki/Misc._Dialplan_Tools_respond">FreeSWITCH wiki</a>
	 */
	 ...
	 *
	 * @throws ExecuteException
	 * @see <a href="http://wiki.freeswitch.org/wiki/Misc._Dialplan_Tools_ring_ready">FreeSWITCH wiki</a>
	 */
	 ...
	 *
	 * @param moduleName     Module name is usually the channel language, e.g. "en" or "es"
	 * @param sayType        Say type is one of the following NUMBER ITEMS PERSONS MESSAGES
	 ...
	 * @param sayMethod      Say method is one of the following N/A PRONOUNCED ITERATED
	 *                       COUNTED
	 * @param optionalGender Say gender is one of the following (For languages with
	 *                       gender-specific grammar, like French and German) FEMININE
	 *                       MASCULINE NEUTER
	 * @param text
	 * @throws ExecuteException
	 * @see <a href="http://wiki.freeswitch.org/wiki/Misc._Dialplan_Tools_say">FreeSWITCH wiki</a>
	 */
	 ...
	 *
	 * @param seconds  the epoc time in the future, or the number of seconds in the
	 *                 future
	 * @param interval is the param seconds an epoc time or interval
	 * @param path     ex: /tmp/howdy.wav
	 * @param leg      can be aleg,bleg,both
	 * @throws ExecuteException
	 */
	 ...
	 *                      future
	 * @param interval      is the param seconds an epoc time or interval
	 * @param optionalCause ex:allotted_timeout
	 * @throws ExecuteException
	 */
	 ...
	 * @throws ExecuteException
	 * @see <a href="http://wiki.freeswitch.org/wiki/Misc._Dialplan_Tools_sched_transfer">FreeSWITCH wiki</a>
	 */
	 ...
	 *
	 * @param digits
	 * @param optionalToneDurationMillis
	 * @throws ExecuteException
	 */
